  ...
  return openBlock(), createElementBlock(
    ...
    [
      !$data.isLocal ? (openBlock(), createElementBlock("view", {
        ...
        }, null, 8, ["content-text"])) : (openBlock(), createElementBlock(
          "u-text",
          { key: 1 },
          toDisplayString(_ctx.mixinDatacomErrorMessage),
          1
          /* TEXT */
        ))
          ...
          $props.multiple ? (openBlock(), createBlock(_component_checkbox_group, {
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($data.dataList, (item, index) => {
                  return openBlock(), createBlock(_component_label, {
                    ...
                    default: withCtx(() => [
                      ...
                      $props.mode !== "tag" && $props.mode !== "list" || $props.mode === "list" && $props.icon === "left" ? (openBlock(), createElementBlock(
                        "view",
                        {
                          key: 0,
                      ...
                      createElementVNode(
                        ...
                        [
                          createElementVNode(
                            ...
                            toDisplayString(item[$props.map.text]),
                            5
                            /* TEXT, STYLE */
                          ),
                          $props.mode === "list" && $props.icon === "right" ? (openBlock(), createElementBlock(
                            "view",
                            {
                              key: 0,
...
const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/uni_modules/uni-data-checkbox/components/uni-data-checkbox/uni-data-checkbox.vue"]]);
export {
  __easycom_1 as _
};
