...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", {
    ...
    createVNode(_component_button, {
      ...
      default: withCtx(() => [
        createTextVNode(
          toDisplayString(!$data.hasSetTabBarBadge ? "设置tab徽标" : "移除tab徽标"),
          1
          /* TEXT */
        )
      ]),
    ...
    createVNode(_component_button, {
      ...
      default: withCtx(() => [
        createTextVNode(
          toDisplayString(!$data.hasShownTabBarRedDot ? "显示红点" : "移除红点"),
          1
          /* TEXT */
        )
      ]),
    ...
    createVNode(_component_button, {
      ...
      default: withCtx(() => [
        createTextVNode(
          toDisplayString(!$data.hasCustomedStyle ? "自定义Tab样式" : "移除自定义样式"),
          1
          /* TEXT */
        )
      ]),
    ...
    createVNode(_component_button, {
      ...
      default: withCtx(() => [
        createTextVNode(
          toDisplayString(!$data.hasCustomedItem ? "自定义Tab信息" : "移除自定义信息"),
          1
          /* TEXT */
        )
      ]),
    ...
    createVNode(_component_button, {
      ...
      default: withCtx(() => [
        createTextVNode(
          toDisplayString(!$data.hasHiddenTabBar ? "隐藏TabBar" : "显示TabBar"),
          1
          /* TEXT */
        )
      ]),
