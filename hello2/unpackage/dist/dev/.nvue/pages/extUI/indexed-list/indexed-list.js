...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", { renderWhole: true }, [
    $props.loaded || $props.list.itemIndex < 15 ? (openBlock(), createElementBlock("view", {
      ...
      $props.list.items && $props.list.items.length > 0 ? (openBlock(), createElementBlock(
        "u-text",
        {
          key: 0,
          class: "uni-indexed-list__title"
        },
        toDisplayString($props.list.key),
        1
        /* TEXT */
    ...
    ($props.loaded || $props.list.itemIndex < 15) && $props.list.items && $props.list.items.length > 0 ? (openBlock(), createElementBlock("view", {
      ...
      (openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList($props.list.items, (item, index) => {
...
const indexedListItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["styles", [_style_0$1]], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/uni_modules/uni-indexed-list/components/uni-indexed-list/uni-indexed-list-item.vue"]]);
    ...
    [
      ...
      createElementVNode(
        ...
        [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList($data.lists, (list, key) => {
              return openBlock(), createElementBlock(
                "view",
                {
                  key,
      ...
      $data.touchmove ? (openBlock(), createElementBlock("view", {
        ...
        createElementVNode(
          ...
          toDisplayString($data.lists[$data.touchmoveIndex].key),
          1
          /* TEXT */
        )
      ])) : createCommentVNode("v-if", true)
...
const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0]], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/uni_modules/uni-indexed-list/components/uni-indexed-list/uni-indexed-list.vue"]]);
const airport = {
  "list": [{
    "letter": "A",
    "data": [
...
const indexedList = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/pages/extUI/indexed-list/indexed-list.nvue"]]);
export {
