...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("view", {
    ...
    $props.showDay ? (openBlock(), createElementBlock(
      "u-text",
      {
        key: 0,
    ...
    createElementVNode(
      ...
      toDisplayString($props.showColon ? ":" : $options.hourText),
      5
      /* TEXT, STYLE */
    ),
    createElementVNode(
    ...
    createElementVNode(
      ...
      toDisplayString($props.showColon ? ":" : $options.minuteText),
      5
      /* TEXT, STYLE */
    ),
    createElementVNode(
    ...
    !$props.showColon ? (openBlock(), createElementBlock(
      "u-text",
      {
        key: 2,
        style: normalizeStyle([$options.splitorStyle]),
      ...
      toDisplayString($options.secondText),
      5
      /* TEXT, STYLE */
    )) : createCommentVNode("v-if", true)
  ]);
}
const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0]], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/uni_modules/uni-countdown/components/uni-countdown/uni-countdown.vue"]]);
const _sfc_main = {
  components: {},
  data() {
    return {
...
const countdown = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/pages/extUI/countdown/countdown.nvue"]]);
export {
