...
const mediaItem = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0$1]], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/pages/template/tabbar/news-item.nvue"]]);
    ...
    createElementVNode("view", { class: "tabs" }, [
      createElementVNode("scroll-view", {
        ...
        (openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList($data.tabBars, (tab, index) => {
      ...
      createVNode(_component_swiper, {
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList($data.newsList, (tab, index1) => {
                  ...
                  default: withCtx(() => [
                    createElementVNode("list", {
                      ...
                      createElementVNode("refresh", {
                        ...
                        createElementVNode("div", { class: "refresh-view" }, [
                          ...
                          createElementVNode(
                            "u-text",
                            { class: "loading-text" },
                            toDisplayString(tab.refreshText),
                            1
                            /* TEXT */
                          )
                        ])
                      ...
                      (openBlock(true), createElementBlock(
                        Fragment,
                        null,
                        renderList(tab.data, (newsitem, index2) => {
                      ...
                      tab.isLoading || tab.data.length > 4 ? (openBlock(), createElementBlock("cell", {
                        ...
                        createElementVNode(
                          ...
                          toDisplayString(tab.loadingText),
                          1
                          /* TEXT */
                        )
                      ])) : createCommentVNode("v-if", true)
...
const tabbar = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/dxs/Documents/personal/github/uni-app-experiments/hello2/pages/template/tabbar/tabbar.nvue"]]);
export {
  tabbar as default
};
